...
module instans {
    ...
    class AssignResourceConstraint implements Constraint {
        appliestogre: EventGroup[];
        appliestoev: AEvent[];
    ...
    class AssignTimeConstraint implements Constraint {
        appliestogre: EventGroup[];
        appliestoev: AEvent[];
    ...
    class Week extends TimeGroup {
    }
    class Day extends TimeGroup {
    }
        ...
        for (var key in tmp) {
            ...
            for (var key2 in curres["ResourceGroups"]["ResourceGroup"]) {
                ...
                if (resourcegrupper[grupid.indexOf(k)] === null)
                    ...
                    nyres.resourcegroups.push(resourcegrupper[grupid.indexOf(k)]);
            }
